...
<form class="waq-form">\
  ...
  <div class="wag-field"><label>What do you need?</label><select name="service"><option value="">Select one</option><option value="Villa Renovation"' + (defaultService === 'villa' ? ' selected' : '') + '>Villa Renovation</option><option value="Kitchen Renovation"' + (defaultService === 'kitchen' ? ' selected' : '') + '>Kitchen Renovation</option><option value="Bathroom Renovation"' + (defaultService === 'bathroom' ? ' selected' : '') + '>Bathroom Renovation</option><option value="Swimming Pool"' + (defaultService === 'pool' ? ' selected' : '') + '>Swimming Pool</option><option value="Glass & Aluminium"' + (defaultService === 'glass' ? ' selected' : '') + '>Glass & Aluminium</option><option value="Full Villa Construction"' + (defaultService === 'construction' ? ' selected' : '') + '>Full Villa Construction</option><option value="Design & Approvals"' + (defaultService === 'design' ? ' selected' : '') + '>Design & Approvals</option><option value="Other">Other</option></select></div>\
